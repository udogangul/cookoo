...
@Api(
        name = "myApi",
        version = "v1",
        namespace = @ApiNamespace(ownerDomain = "api.mycookooapp.appspot.com", ownerName = "api.mycookooapp.appspot.com", packagePath = "")
)
public class MyEndpoint {
    ...
    public Data sayHi(@Named("name") String name) {
