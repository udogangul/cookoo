...
public class EventEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.23.0 of the eventEndpoint library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  /**
   * Create a request for the method "removeAllEvents".
   *
   * This request holds the parameters needed by the eventEndpoint server.  After setting any optional
   * parameters, call the {@link RemoveAllEvents#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public RemoveAllEvents removeAllEvents() throws java.io.IOException {
    RemoveAllEvents result = new RemoveAllEvents();
    initialize(result);
    return result;
  }

  public class RemoveAllEvents extends EventEndpointRequest<Void> {

    private static final String REST_PATH = "allevents";

    /**
     * Create a request for the method "removeAllEvents".
     *
     * This request holds the parameters needed by the the eventEndpoint server.  After setting any
     * optional parameters, call the {@link RemoveAllEvents#execute()} method to invoke the remote
     * operation. <p> {@link RemoveAllEvents#initialize(com.google.api.client.googleapis.services.Abst
    ...
    @Override
    public RemoveAllEvents setAlt(java.lang.String alt) {
      return (RemoveAllEvents) super.setAlt(alt);
    }

    @Override
    public RemoveAllEvents setFields(java.lang.String fields) {
      return (RemoveAllEvents) super.setFields(fields);
    }

    @Override
    public RemoveAllEvents setKey(java.lang.String key) {
      return (RemoveAllEvents) super.setKey(key);
    }

    @Override
    public RemoveAllEvents setOauthToken(java.lang.String oauthToken) {
      return (RemoveAllEvents) super.setOauthToken(oauthToken);
    }

    @Override
    public RemoveAllEvents setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (RemoveAllEvents) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public RemoveAllEvents setQuotaUser(java.lang.String quotaUser) {
      return (RemoveAllEvents) super.setQuotaUser(quotaUser);
    }

    @Override
    public RemoveAllEvents setUserIp(java.lang.String userIp) {
      return (RemoveAllEvents) super.setUserIp(userIp);
    }

    @Override
    public RemoveAllEvents set(String parameterName, Object value) {
      return (RemoveAllEvents) super.set(parameterName, value);
    }
  }
